...
export const translations: TranslationDictionary = {
  ...
  "dashboard.number_of_orders": { en: "Number of Orders", ur: "Orders Ki Tadaad" },
  "dashboard.today_orders": { en: "Orders Today", ur: "Aaj Ke Orders" },
  ...
  "dashboard.low_stock_products": { en: "Low Stock Products", ur: "Kam Stock Wali Ashya" },
  "dashboard.top_selling_products": { en: "Top Selling Products", ur: "Ziyada Bikne Wali Ashya" },
  "dashboard.units_sold": { en: "units sold", ur: "ashya biki" },
  "dashboard.all_healthy_stock": { en: "All stock levels healthy! No inventory alerts.", ur: "Tamam samaan ka stock behtar hai! Koi alert nahi." },
  "dashboard.view_all_products": { en: "View All Products", ur: "Tamam Samaan Dekhein" },
  "dashboard.restock": { en: "Restock", ur: "Stock Barhaein" },
